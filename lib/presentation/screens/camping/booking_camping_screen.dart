...
class _BookingCampingScreenState extends State<BookingCampingScreen> {
  ...
  Future<void> _loadPaket() async {
    // ✅ Load dari API via WisataRepository (sudah terhubung ke /wisata/{id}/paket-camping)
  ...
  Future<void> _booking() async {
    ...
    // ✅ Kirim ke API nyata (bukan memori lokal)
    ...
    context.read<NotifikasiProvider>().tambahNotifikasi(
      judul: 'Booking Camping Berhasil! ⛺',
      pesan :
          '${_selected!.namaPaket} selama $_durasi malam senilai ${CurrencyFormatter.format(_total)} berhasil dibuat. Silakan selesaikan pembayaran.',
      tipe: 'paket',
    );

    final String bookingId = (r['success'] == true)
        ? (r['booking_id'] ?? 'BCP-${DateTime.now().millisecondsSinceEpoch}')
        : 'BCP-${DateTime.now().millisecondsSinceEpoch}';
            ...
            child: _loadingPaket
                ...
                : SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        _buildSectionLabel('Pilih Paket Tersedia'),
  ...
  Widget _buildHeader() => Container(
        ...
        decoration: const BoxDecoration(
          gradient: LinearGradient(
            colors: [Color(0xFFE65100), AppColors.primaryOrange],
          ...
          children: [
            ...
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('Booking Paket Camping',
                      style: GoogleFonts.plusJakartaSans(
                        color: Colors.white, fontSize: 18,
                        fontWeight: FontWeight.w800, letterSpacing: -0.3,
                      )),
                  Text('Pilih paket & durasi kemah favoritmu',
                      style: GoogleFonts.plusJakartaSans(
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Text('Total Durasi: $_durasi Malam',
                      style: GoogleFonts.plusJakartaSans(
                        fontWeight: FontWeight.w800,
                        color: AppColors.darkOrange, fontSize: 13,
                      )),
                ],
              ),
            ),
  ...
  Widget _counterBtn(IconData ico, bool enabled, VoidCallback onTap) =>
      GestureDetector(
        ...
        child: Container(
          width: 34, height: 34,
          decoration: BoxDecoration(
            color: enabled ? AppColors.primaryOrange : AppColors.background,
  ...
  Widget _buildSummary() => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            _sumRow('Paket Camping', _selected?.namaPaket ?? '-'),
            _sumRow('Durasi', '$_durasi Malam'),
            _sumRow('Peserta', '$_jumlahTamu Orang'),
